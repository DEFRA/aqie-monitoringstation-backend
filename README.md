...
```bash
cd aqie-monitoringstation-backend
nvm use
```
...
```bash
docker build --target development --no-cache --tag aqie-monitoringstation-backend:development .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 aqie-monitoringstation-backend:development
```
...
```bash
docker build --no-cache --tag aqie-monitoringstation-backend .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 aqie-monitoringstation-backend
```
